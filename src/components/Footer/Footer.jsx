    ...
    <footer className="px-3 my-3">
      <div className="bg-[#0b1c3a] flex flex-col h-screen text-white p-10 rounded-3xl">
        <div className="flex justify-between">
          ...
          <div className="flex gap-25">
            ...
            <div>
              ...
              <ButtonPrimary className="bg-white! text-[#0b1c3a]! hover:bg-gray-100! font-semibold ">
                More Templates
              </ButtonPrimary>
            </div>
          </div>
        ...
        <div className=" mt-auto pt-6 flex flex-col md:flex-row justify-between text-gray-400 text-base">
          <p>
            © Rights reserved by <span className="text-white">Tripvana</span> -
            Powered by <span className="text-white">Webflow</span>
          </p>
          <p>
            Design and developed by <span className="text-white">Pixoora</span>
          </p>
        </div>
      </div>
    </footer>
